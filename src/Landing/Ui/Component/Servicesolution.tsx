...
const ServiceItem = ({ service }:any) => (
    <div
        className={`group bg-transparent hover:bg-blueSmart transition duration-300 hover:text-white h-full ${
            service.isActive && "bg-gray-700 text-white"
        }`}
    >
        <div className="p-6 lg:py-12">
            <div
                className={`bg-blueSmart bg-opacity-10 text-blueSmart w-32 h-32 rounded-full text-6xl inline-flex justify-center items-center group-hover:bg-white group-hover:bg-opacity-10 group-hover:text-white ${

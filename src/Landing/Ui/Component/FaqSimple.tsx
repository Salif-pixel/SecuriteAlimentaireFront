...
export function Fonctionnement() {
    return (
        <motion.div initial={{opacity: 0, y: 200}}  animate={{opacity: 1, y: 0}}
            ...
            <h1 className="text-4xl md:text-[3.5rem] font-gotham font-bold  text-center text-orangeSmart mb-10 mt-4">
                Le fonctionnement de <br/>
                <span
                    className="text-5xl md:text-[6rem] font-gotham font-bold  text-center  mt-1 text-orangeSmart leading-none">
                                  Eath
                               </span>
            </h1>

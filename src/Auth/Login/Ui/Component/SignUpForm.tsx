...
import {PasswordStrength} from "../../../../component/Demo/PasswordRequirement.tsx";
            ...
            <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white ">
                ...
                <form className="my-8" onSubmit={handleSubmit}>
                    <LabelInputContainer className="mb-4 font-gotham font-bold">
                        <Label htmlFor="firstname" className={`font-gotham font-bold`}>Nom complet</Label>
                        <Input id="firstname" placeholder="Tyler" type="text"/>
                    </LabelInputContainer>
                    <LabelInputContainer className="mb-4 font-gotham font-bold">
                        <Label htmlFor="email" className={`font-gotham font-bold`}>Addresse mail</Label>
                        <Input id="email" placeholder="utilisateur@gmail.com" className={`font-gotham font-bold`}
                               type="email"/>
                    </LabelInputContainer>
                    <LabelInputContainer className="mb-4 font-gotham font-bold">
                        <PasswordStrength/>
                    ...
                    <LabelInputContainer className="mb-4 font-gotham font-bold">
                        <Label htmlFor="password" className={`font-gotham font-bold`}>Confirmer mot de passe</Label>
